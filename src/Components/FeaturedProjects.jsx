    ...
    const projects = [
        {
            ...
            description: "בלוג אוכל טבעוני בעל עיצוב מדויק ומוקפד, עם מערכת ניהול תוכן מתקדמת שמקנה נוחות משתמש רבה. הפלטפורמה מעודדת חשיפה מוגברת ומקדמת מכירות דרך שילוב של כלים חכמים ותוכן איכותי.",
